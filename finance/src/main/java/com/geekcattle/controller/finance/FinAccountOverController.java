 ...
 */
@Controller
@RequestMapping("/console/accountover")
public class FinAccountOverController {
    ...
    @RequiresPermissions("accountover:index")
    @RequestMapping(value = "/index", method = {RequestMethod.GET})
    public String index(Model model) {

        return "console/accountover/index";
    }
    ...
    public ModelMap list(FinGeneralLedger finGeneralLedger) {
        ...
        List<FinGeneralLedger> Lists = service.getAccountover(finGeneralLedger);
